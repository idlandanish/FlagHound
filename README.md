...
- **🗂️ Recursive Archive Extraction**: Automatically unzips nested `.zip`, `.tar`, `.gz`, `.bz2`, `.xz` up to **10 layers deep**. Includes safe guards against zip-bombs.
...
- **♻️ Auto-Decoding**: Recursively decodes Base64, Hex, Rot13, and URL encoding until plaintext emerges.
- **🛡️ Robustness**: Global error recovery (skips corrupt files), verbose logging, and safe path handling.
